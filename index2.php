    ...
    <nav class="sidebar-nav">
      <ul>
        <li>
          ...
          <ul class="nav-flyout">
            <li>
              <a href="index.php"><i class="ion-ios-color-filter-outline"></i>hola</a>
            </li>
            <li>
...
<section class="app2" style="background-image: url(img/logoDetalladoF2.png);">
  <img src="img/logoDetalladoF2.png">
</section>
</body>
</html>