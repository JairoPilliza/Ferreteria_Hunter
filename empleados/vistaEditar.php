...
$id=$_GET['id'];
$query=$db->query("select * from empleados where empId=$id");
$mostrar = mysqli_fetch_array($query);
$id2=$mostrar['empId'];
$nombre=$mostrar['empNombre'];
$cedula=$mostrar['empCedula'];
$clave=$mostrar['empClave'];
?>
 <meta charset="UTF-8">
	...
	<div class="d-flex justify-content-center h-100">
		<div class="card col col-lg-6" style="background-image:url('https://ae01.alicdn.com/kf/HTB1tOvwm29TBuNjy0Fcq6zeiFXaA.jpg');">
			<div class="card-header">
				<br>
				<h3>Modificacion de Empleados</h3>
