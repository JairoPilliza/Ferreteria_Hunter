   ...
   <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.3.1/css/all.css" integrity="sha384-mzrmE5qonljUremFsqc01SB46JvROS7bZs3IO2EmfFsd15uHvIt+Y8vEf7N7fWAU" crossorigin="anonymous">
    ...
    <script>
        function cargarDatos() {
            ...
            xhttp.open("GET", "empleado.php?accion=buscarTodos");
            xhttp.send();
        }
        ...
        function buscarId(id) {
            ...
            xhttp.onload = function() {
                ...
                document.getElementById('cedula').value = res[2];
                document.getElementById('clave').value = res[3];
            }
            xhttp.open("GET", "empleado.php?accion=buscarId&id=" + id);
            xhttp.send();
        }
        ...
        function eliminar(id) {
            ...
            xhttp.open("GET", "empleado.php?accion=eliminar&id=" + id);
            xhttp.send();
        }
        ...
        function guardar() {
            ...
            xhttp.open("GET", "empleado.php?accion=guardar&id=" + id + "&nombre=" + nombre + "&cedula=" + cedula + "&clave=" + clave);
        ...
        function modificar() {
            ...
            xhttp.open("GET", "empleado.php?accion=modificar&id=" + id + "&nombre=" + nombre + "&cedula=" + cedula + "&clave=" + clave);
        ...
        function buscarDatos() {
            ...
            xhttp.open("GET", "empleado.php?accion=filtro&palabra=" + a);
            xhttp.send();
        }
    </script>
</head>
    ...
    <nav class="sidebar-nav" >
      <ul >
        ...
        <li>
          ...
          <ul class="nav-flyout">
            <li>
              <a href="index.php"><i class="fas fa-business-time"></i>Gestion Empleados</a>
            </li>
            <li>
              <a href="#"><i class="fas fa-file-pdf"></i>Reportes</a>
            </li>
...
<section class="app2" style="background-image: url(../img/logoDetalladoF3.png); background-size: 100% 100%; background-repeat: no-repeat;">
    <center>
        <h1 style=color:white;>Gestion Empleados</h1>
    </center>
    <div class=container>
