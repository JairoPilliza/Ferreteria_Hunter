...
$id=$_GET['id'];
$query="select * from clientes where cliid=$id";
...
<div class="container">
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			...
			<div class="card-body">
				<form method="get" name="frmUsuarios" onsubmit="return validar()" action="cliente3.php">
                <div class="input-group form-group">
						<div class="input-group-prepend">
							<span class="input-group-text"><i class="fas fa-paw"></i></span>
						</div>
						<input type="text" class="form-control" placeholder="id" name="id" required value="<?php echo $ver['cliId'] ?>">
					...
					<div class="input-group form-group">
						...
						<input type="text" class="form-control" placeholder="Cedula" name="cedula" required value="<?php echo $ver['cedula'] ?>">
					...
					<div class="input-group form-group">
						...
						<input type="text" class="form-control" placeholder="Nombre" name="nombre" maxlength="30" required value="<?php echo $ver['nombre'] ?>">
					...
					<div class="input-group form-group">
						...
						<input type="text" class="form-control" placeholder="Direccion" name="direccion" value="<?php echo $ver['direccion'] ?>" required>
					...
					<div class="input-group form-group">
						...
						<input type="password" class="form-control" placeholder="Password" name="password" id="password" value="<?php echo $ver['clave'] ?>" required>
					</div>
					<div class="input-group form-group">
						<div class="input-group-prepend">
							<br><span class="input-group-text"><i class="fas fa-key"></i></span>
						</div>
						<input type="password" class="form-control" placeholder="Confirmar Password" name="password2" id="password2" value="<?php echo $ver['clave'] ?>" required>
					</div>
					
					<div class="form-group">
						<input type="submit" name="enviar" value="Modificar" class="btn float-right login_btn">
					</div>
				</form>
			</div>
		</div>
